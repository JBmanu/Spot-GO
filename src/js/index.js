...
let loadProfileOverview, initializeHomepageFilters, initializeMap, initializeGoals, initializeCommunity;
...
const modulesLoaded = Promise.allSettled([
    ...
    import("./pages/community.js").then(m => initializeCommunity = m.loadCommunityData),
]);
